...
import { FaMoon, FaBell, FaInbox } from "react-icons/fa";
import { SlCalender } from "react-icons/sl";
import { FaAnglesLeft } from "react-icons/fa6";

const Navbar = ({ toggleSidebar }) => {
  const navbarLinks = [
    { icon: <FaMoon fontSize={"1.1rem"} />, link: "" },
    { icon: <FaBell fontSize={"1.1rem"} />, link: "" },
    { icon: <FaInbox fontSize={"1.1rem"} />, link: "" },
    { icon: <SlCalender fontSize={"1.1rem"} />, link: "" },
  ];
  return (
    <div>
      {/* <div className="w-full  bg-gray-100 border-b-0 inline-flex justify-between">
        ...
        <div className="me-2 mt-1 py-2">
          <ul className="inline-flex  p-0">
            {navbarLinks.map((item, index) => {
              return (
                <li key={index}>
                  <div className="m-1 p-2.5 rounded-sm bg-white ">
            ...
            <li>
              <div className="w-10 h-10 m-0.5 ms-2 rounded-md bg-white  ">
                <img
                  src="./1193515.jpg"
                  alt=""
      ...
      <div className="w-full bg-gray-100 border-b flex border-gray-200 justify-between items-center">
        <div className="flex items-center py-2">
         
          <button
            onClick={toggleSidebar}
            className="bg-blue-900 hover:bg-white hover:text-blue-900 text-white p-2 font-bold transition-all  rounded-md ms-2"
          >
            
           <FaAnglesLeft fontSize={'1.1rem'}/>
          </button>
          <h1 className="text-2xl font-bold text-gray-800 dark:text-white hidden lg:block ms-2">
            Dashboard
          </h1>
        </div>
        <div className="me-2 py-2">
          <ul className="inline-flex p-0 items-center">
            {navbarLinks.map((item, index) => {
              return (
                <li key={index}>
                  <div className="m-1 p-2.5 rounded-sm bg-white">
            ...
            <li>
              <div className="w-10 h-10 m-0.5 ms-2 rounded-md bg-white flex items-center justify-center">
                <img
                  src="./1193515.jpg"
                  alt=""
                  className="w-10 h-10 rounded-md"
